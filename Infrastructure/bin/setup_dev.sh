...
oc new-app mongodb-persistent --param MONGODB_DATABASE="mongodb" MONGODB_USER="mongodb_user" MONGODB_PASSWORD="mongodb_password" MONGODB_ADMIN_PASSWORD="mongodb_admin_password"
